...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkman?method=addLinkman"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td><input type="radio" value="男" name="lkm_gender">男
									<input type="radio" value="女" name="lkm_gender">女</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
