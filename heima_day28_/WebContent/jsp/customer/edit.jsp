...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/customer?method=saveOrUpdate"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<TR>
								<td>信息来源：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_source"
									value="${customer.cust_source }"></td>
								<td>联系人：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
							...
							<TR>
								<td>联系地址 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_address"
									value="${customerDetail.cust_address }"></td>
								<td>邮政编码 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_zip"
									value="${customerDetail.cust_zip }"></td>
							</TR>
							<TR>
								<td>客户传真 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_fax"
									value="${customerDetail.cust_fax }"></td>
								<td>客户网址 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_website"
									value="${customerDetail.cust_website }"></td>
							</TR>
							<tr>
