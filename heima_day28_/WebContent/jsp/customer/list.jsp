					...
					<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%"
						...
						<TBODY>
							<TR>
								<TD height=25>
									<FORM
										action="${pageContext.request.contextPath }/customer?method=getListUI"
										method="post">
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="nameValue"></TD>
										...
										<TBODY>
											...
											<c:forEach items="${list }" var="customer">
												<TR
													...
													<TD><a
														href="${pageContext.request.contextPath }/customer?method=editUI&custId=${customer.cust_id}">修改</a>
														&nbsp;&nbsp; <a
														href="${pageContext.request.contextPath }/customer?method=delete&custId=${customer.cust_id}">删除</a>
													</TD>
												</TR>
